...
## Parameter files
Parameter files used for all runs are all located in https://github.com/gygilab/mintseris_gygi_PNAS

## Fasta sequence dtabases
All fasta databases are located in https://github.com/gygilab/mintseris_gygi_PNAS.  Note that reverse sequences by default are denoted by a "##' tag at the beginning of the header.
